...
def mmbh_from_txt(realization_seed):
    ...
    # path_run = '/physics2/kuanweih/project_BH_seedmass/simulation_zoo/run_20Mpc_{}/Con_2/'.format(realization_seed)
    kwbh = KWBHS(path_run)
    ...
    import os
    import errno
    # dir_name = 'mmbhdata/15Mpc_{}_{}_high396/'.format(realization_seed[:6],realization_seed[-3:])
    # dir_name = 'mmbhdata/15Mpc_{}_{}_newcode/'.format(realization_seed[:6],realization_seed[-3:])
    # dir_name = 'mmbhdata/15Mpc_{}_{}_samefof/'.format(realization_seed[:6],realization_seed[-3:])
    dir_name = 'mmbhdata/10Mpc_{}_{}/'.format(
        realization_seed[:6], realization_seed[-3:])
    # dir_name = 'mmbhdata/10Mpc_{}_{}/'.format(realization_seed[:6],realization_seed[-3:])
